...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validasi kecocokan password sebelum kirim ke backend
        ...
        <div className="mx-auto w-full max-w-md my-auto py-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-slate-500">
              Lengkapi form di bawah dengan data kamu yang valid.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {fieldErrors.length > 0 && (
              <div className="rounded-xl bg-red-50 px-4 py-3 text-sm text-red-700 border border-red-100">
                <p className="font-medium">Password belum memenuhi syarat:</p>
            ...
            <div>
              <label htmlFor="name" className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-1.5">
                Nama Lengkap <span className="font-normal text-slate-400 lowercase">(maks. 50 karakter)</span>
              </label>
              <input
                id="name"
                type="text"
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-bold uppercase tracking-wider text-slate-600 mb-1.5">
                Password <span className="font-normal text-slate-400 lowercase">(maks. 24 karakter)</span>
              </label>
            ...
            {/* Input Ulangi Password dengan Icon Mata */}
            <div>
